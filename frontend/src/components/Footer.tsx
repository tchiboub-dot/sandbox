  ...
  return (
    <footer className="mt-16 border-t border-white/10 bg-slate-950/70 backdrop-blur-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mt-10 rounded-2xl border border-primary-300/30 bg-gradient-to-r from-primary-600/15 via-slate-900 to-primary-500/15 px-6 py-5 shadow-[0_0_40px_rgba(14,165,233,0.14)] text-center">
          <p className="text-slate-200 flex items-center justify-center gap-2 font-medium">
